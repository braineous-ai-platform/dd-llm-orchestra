 ...
 */
public class RegistrationResult extends OrchestraBaseModel {
    ...
    public static RegistrationResult success(String engineWorkflowName, Integer engineWorkflowVersion) {
    ...
    public static RegistrationResult failure(String whyCode, String details) {
        if (whyCode == null) {
